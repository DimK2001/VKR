...
{
	//Change param
	private int[] range = new int[] {64, 220, 260, 400, DATA.CHUNK_SIZE + 1};
	...
	public String[] CountParam() throws UnsupportedAudioFileException, IOException
	{
		...
		for (int i = 0; range[1] + 10 < 1025; i += 10)
		{
			range = new int[] {65, 250+i, 1025, 1035, DATA.CHUNK_SIZE + 1};
			...
			path = Paths.get(".\\Test\\" + "Bad Apple.wav");
			determinatedData = openFile(path);
